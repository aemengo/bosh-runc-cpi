...
type CPIDClient interface {
	...
	StreamIn(ctx context.Context, opts ...grpc.CallOption) (CPID_StreamInClient, error)
}
...
func (c *cPIDClient) StreamIn(ctx context.Context, opts ...grpc.CallOption) (CPID_StreamInClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CPID_serviceDesc.Streams[2], "/pb.CPID/StreamIn", opts...)
	if err != nil {
		return nil, err
	}
	x := &cPIDStreamInClient{stream}
	return x, nil
}

type CPID_StreamInClient interface {
	Send(*DataParcel) error
	CloseAndRecv() (*Void, error)
	grpc.ClientStream
}

type cPIDStreamInClient struct {
	grpc.ClientStream
}

func (x *cPIDStreamInClient) Send(m *DataParcel) error {
	return x.ClientStream.SendMsg(m)
}

func (x *cPIDStreamInClient) CloseAndRecv() (*Void, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Void)
...
type CPIDServer interface {
	...
	StreamIn(CPID_StreamInServer) error
}
...
func _CPID_StreamIn_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CPIDServer).StreamIn(&cPIDStreamInServer{stream})
}

type CPID_StreamInServer interface {
	SendAndClose(*Void) error
	Recv() (*DataParcel, error)
	grpc.ServerStream
}

type cPIDStreamInServer struct {
	grpc.ServerStream
}

func (x *cPIDStreamInServer) SendAndClose(m *Void) error {
	return x.ServerStream.SendMsg(m)
}

func (x *cPIDStreamInServer) Recv() (*DataParcel, error) {
	m := new(DataParcel)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _CPID_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "StreamIn",
			Handler:       _CPID_StreamIn_Handler,
			ClientStreams: true,
		},
	},
...
var fileDescriptor_4dc296cbfe5ffcd5 = []byte{
	...
	,
}
